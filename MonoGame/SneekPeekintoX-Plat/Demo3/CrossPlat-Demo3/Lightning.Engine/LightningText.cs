...
namespace Lightning.Engine
{
	class LightningText
	{
		...
		public LightningText(GraphicsDevice device,Point screenSize, SpriteBatch spriteBatch, SpriteFont font, string text)
		{
			this.spriteBatch = spriteBatch;
			textParticles = CreateParticleText(device, font, text);

            Vector2 offset = new Vector2(screenSize.X, screenSize.Y) / 2;
